...
var MouseTracker = function MouseTracker(_ref) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    if (mouseRef.current) {
      ...
      mouseRef.current.style.transform = "translate3d(".concat(x, "px, ").concat(y, "px,0px)"); // mouseRef.current.style.left = `${x}px`;
      // mouseRef.current.style.top = `${y}px`;

      if (isOver) {
        mouseRef.current.style.transform = "matrix(1,0,0,1,".concat(x, "px, ").concat(y, "px)");
      }
    }
...
//# sourceMappingURL=index.js.21e893c86f25a4fa249b.hot-update.js.map