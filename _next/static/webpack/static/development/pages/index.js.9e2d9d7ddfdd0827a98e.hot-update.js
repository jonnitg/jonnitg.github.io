...
var ThemeSettings = function ThemeSettings() {
  ...
  }, "Text Color"), showThemePicker && __jsx(react_color__WEBPACK_IMPORTED_MODULE_1__["TwitterPicker"], {
    colors: colors,
    width: 315,
    onChangeComplete: function onChangeComplete(color, event) {
      return handleChangeComplete(color, event, 'theme');
    },
    __self: _this,
    __source: {
      fileName: _jsxFileName,
  ...
  }), showTextPicker && __jsx(react_color__WEBPACK_IMPORTED_MODULE_1__["TwitterPicker"], {
    colors: colors,
    width: 315,
    onChangeComplete: function onChangeComplete(color, event) {
      return handleChangeComplete(color, event, 'text');
    },
    __self: _this,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=index.js.9e2d9d7ddfdd0827a98e.hot-update.js.map